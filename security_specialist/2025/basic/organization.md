...
また、技術的な対策だけでなく、従業員の教育、訓練、組織体制の整備なども含まれる。

認証基準となるのはJIS Q 27017:2016。
...
1. 取得
   利用目的の特定と本人への通知、公表。適正な手段による取得
2. 保管・管理
   安全管理措置
3. 第3者への提供
   本人の同意が必要で、オプトアウト手続きが可能

ソフトウェア管理ガイドライン

ソフトウェアの違法複製を奉仕するため、法人、団体を対象として、実施すべき事項をとりまとめたもの。

ソフトウェアの違法複製の防止が目的。

#### 共通フレーム

ソフトウェアの構想から開発、運用、保守、廃棄までのライフサイクルを通じて必要な作業項目、役割を包括的に規定した共通の枠組み。

ITシステム開発の作業規定

規定の目的はシステム開発に関与する人々がい同じ言葉で話すことが出来るようにすること

![1739609289328](image/organization/1739609289328.png)
